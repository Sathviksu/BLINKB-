        ...
        <div className="box h-[80%] w-[80%] bg-white rounded-2xl shadow-[0_0_30px_#865DFF]">
          <div className="up flex justify-evenly  text-black">
            ...
            <ul className="community">
              <li className="text-2xl font-semibold pb-5 pt-[50px]">
                Community
              </li>
          ...
          <div className="down pt-[50px] flex pl-[100px] gap-4">
            <button className="text-[20px] hover:bg-[#232323] bg-black h-[55px] w-[120px] rounded-4xl">
              Login
            </button>
            <button
              onClick={() => createblink()}
              className="text-[18px] text-black hover:bg-[#a0a93b] bg-[#F7EC09] h-[55px] w-[180px] rounded-4xl"
            >
